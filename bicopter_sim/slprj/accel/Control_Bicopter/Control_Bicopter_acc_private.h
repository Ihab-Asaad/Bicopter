...
#ifndef RTW_HEADER_Control_Bicopter_acc_private_h_
#define RTW_HEADER_Control_Bicopter_acc_private_h_
#include "rtwtypes.h"
...
; real_T Control_Bicopter_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
